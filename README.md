...
`atp/live` innehåller live-matcher som displaytext, till exempel `Sinner - Alcaraz 6-4 2-1 [30-15]`.
`atp/odds` innehåller liveodds med kort matchnamn, till exempel `Tiafoe - Arnaldi (1.92/1.92)`.
`atp/scoreboard` kombinerar livescore och odds, till exempel `Tiafoe - Arnaldi 6-7 7-6 [40-0] (1.93/1.87)`.
